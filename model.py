...
#PSMNet_hourglass inherets nn.Module
class PSMNet_hourglass(nn.Module):
    def __init__(self, maxdisp):
        super(PSMNet_hourglass, self).__init__()
        self.maxdisp = maxdisp

        self.feature_extraction = feature_extraction()
        #convbn_3d is a conv3d layer followed by batch normalization
